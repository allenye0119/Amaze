...
This page describes how to build a custom prediction algorithm using Amaze.
...
<amaze.prediction_algorithms.algo_base.AlgoBase>` that has an ``estimate``
method.  This is the method that is called by the :meth:`predict()
<amaze.prediction_algorithms.algo_base.AlgoBase.predict>` method. It takes
...
<amaze.prediction_algorithms.predictions.Prediction>` as the ``details``
...
<amaze.model_selection.validation.cross_validate>` function at each fold of
...
base class :meth:`fit()
<amaze.prediction_algorithms.algo_base.AlgoBase.fit>` method.
...
<amaze.prediction_algorithms.algo_base.AlgoBase.fit>` method has returned,
...
<amaze.Trainset>` object that has many attributes and methods of
...
<amaze.prediction_algorithms.predictions.PredictionImpossible>` exception.
You'll need to import it first: ::

    from amaze import PredictionImpossible


This exception will be caught by the :meth:`predict()
<amaze.prediction_algorithms.algo_base.AlgoBase.predict>` method, and the
estimation :math:`\hat{r}_{ui}` will be set according to
the :meth:`default_prediction()
<amaze.prediction_algorithms.algo_base.AlgoBase.default_prediction>` method,
...
<amaze.prediction_algorithms.algo_base.AlgoBase.compute_baselines>`   and
:meth:`compute_similarities()
<amaze.prediction_algorithms.algo_base.AlgoBase.compute_similarities>` can
...
<https://github.com/NicolasHug/Amaze/tree/master/amaze/prediction_algorithms>`_
