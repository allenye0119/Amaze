...
Welcome to Amaze' documentation!
===================================

`Amaze <http://amazelib.com>`_  is an easy-to-use Python `scikit
<https://www.scipy.org/scikits.html>`_ for recommender systems.

If you're new to `Amaze <http://amazelib.com>`_, we invite you to take a
look at the :ref:`getting_started` guide, where you'll find a series of
tutorials illustrating all you can do with  `Amaze
<http://amazelib.com>`_. You can also check out the :ref:`FAQ` for many
use-case example. For installation guidelines, please refer to the `project
page <http://amazelib.com>`_.
...
<https://github.com/NicolasHug/Amaze>`_)!
